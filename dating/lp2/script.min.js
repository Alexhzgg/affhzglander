...
function clear_delay(n){window.clearTimeout(n)}function run_loading_run_1(n){timeoutID1=window.setTimeout(run_loading_1,n)}function run_loading_1(){$(".thank_for_close, .run_loading_2").fadeIn(),$(".main_review").hide()}function run_loading_run_2(n){timeoutID2=window.setTimeout(run_loading_2,n)}function run_loading_2(){$(".thank_for_close, .run_loading_2").hide(),$(".run_loading_3, .li_run_loading_1, .li_run_loading_2").fadeIn()}function run_loading_run_3(n){timeoutID3=window.setTimeout(run_loading_3,n)}function run_loading_3(){$(".run_loading_3").hide(),$(".run_loading_4, .li_run_loading_3").fadeIn()}function run_loading_run_4(n){timeoutID3=window.setTimeout(run_loading_4,n)}function run_loading_4(){$(".run_loading_4, .loading").hide(),$(".li_run_loading_4, li_run_loading_5, .run_loading_5, .show_end").fadeIn()}$(function(){$(document).on("click",".next",function(n){n.preventDefault(),$(this).parent().hide().next().fadeIn()}),$(document).on("click",".run_loading",function(n){n.preventDefault(),$(this).parent().hide().next().fadeIn(),$(".step4 .loading").show(),run_loading_run_1("1000"),run_loading_run_2("2250"),run_loading_run_3("3000"),run_loading_run_4("4000")})});
