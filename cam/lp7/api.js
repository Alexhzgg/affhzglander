...
(function () {
    ...
    (window[CFG]['render'] = window[CFG]['render'] || []).push('6LfOt3cUAAAAAMCmwEO6NoLzIGrsk1XvNRJQwooI');
    window['__google_recaptcha_client'] = true;
    var po = document.createElement('script');
    po.type = 'text/javascript';
    po.async = true;
    po.src = 'https://www.gstatic.com/recaptcha/api2/v1550471573786/recaptcha__en.js';
